...
<section>
    <h2>Instructions</h2>
    <h3>Please answer the questions with 0 - 5 (disagree - agree) range</h3>

    <div>
        <p>1. Do you like to party<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
            <input name="4" type="radio" /> 4 
            <input name="5" type="radio" /> 5 
        </form>
    <div>

    <div>
        <p>2. You like do shop a lot<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>3. You want to investigate why something happen<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>4. You can stay in a conversation for a while<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>5. You play video games for a while<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>6. You play any kinds of sports very often<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>7. You love to travel around the world<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>8. You would rather observe and listen than speaking<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>9. You are the best mathematician<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p>10. You talk about politics more often<p>
        <form>
            <input name="1" type="radio" /> 1 
            <input name="2" type="radio" /> 2
            <input name="3" type="radio" /> 3 
    ...
    <div>
        <p><a href="result.php">Submit</a></p>
</section>
